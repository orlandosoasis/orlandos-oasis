...
export interface AdminHomeownerAggregate {
  ...
  services: { id: string; date: string; serviceDate: string; type: string; technicianName: string; technicianId: string | null; status: "Completed" | "Scheduled"; poolId: string; createdAt: string; updatedAt: string }[];
}

        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-4">
          {GALLERY_ITEMS.map((item, i) => (
            ...
            >
              ...
              {/* Label — bottom-centered overlay */}
              <span className="absolute bottom-3 md:bottom-4 left-1/2 -translate-x-1/2 z-[2] bg-card/90 backdrop-blur-sm text-foreground text-xs font-semibold px-3 py-1 rounded-full border border-border shadow-md whitespace-nowrap">
                {item.label}
              </span>
            </button>
          ))}

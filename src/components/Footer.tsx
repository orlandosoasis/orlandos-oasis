...
const Footer = () => {
  return (
    <footer role="contentinfo" aria-label="Site footer" className="py-10 md:py-8" style={{ background: 'hsl(210 60% 12%)' }}>
      <div className="container max-w-6xl mx-auto px-4 md:px-6">
        ...
        <div className="flex flex-col items-center text-center gap-4 md:flex-row md:items-center md:justify-between md:text-left md:gap-6">
          ...
          {/* Links */}
          <nav aria-label="Footer" className="flex flex-wrap items-center justify-center gap-x-5 gap-y-3 text-sm">
